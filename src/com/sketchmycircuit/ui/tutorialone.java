...
public class tutorialone extends Activity {
	...
	int[] images = { R.drawable.initialcircuit, R.drawable.erasegesture,
			R.drawable.componentgestures, R.drawable.clearall,
			R.drawable.exportbutton, R.drawable.exportgesture };
